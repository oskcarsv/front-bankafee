            ...
            <div className="content-product-info">
                ...
                <div className="content-info-product">
                    ...
                    <div className="content-description">
                        <p className="description">Laptop Huawei Core i5, 13", 16GB RAM, 512GB SSD</p>
                    </div>
                    <form className="form-buy">
                        ...
                        <div className="content-input-buy">
                            <input type="number" placeholder="Monthly" className="input-buy-product" />
                        </div>
                        <div className="content-btn-buy">
                            <Link to="/home" className="link-btn"><button className="btn-buy">Buy</button></Link>
                            <Link to="/productCategory" className="link-btn"><button className="btn-buy-cancel">Cancel</button></Link>
                        </div>
                    </form>
                </div>
            </div>
