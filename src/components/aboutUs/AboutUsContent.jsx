...
export const AboutUsContent = () => {
  return (
    <main className="content-about">
      <section className="about-us-1">
        <div className="about-us-text-left">
          ...
          <p className="about-us-content-left">
            Estamos aquí para convertirnos en el aliado que transforma la vida y
            que acerca de una forma más simple, humana y transparente los
      ...
      <section className="about-us-1">
        <div className="about-us-text-left">
          <h1 className="about-us-title">Tu libertad es nuestra bandera</h1>
          <p className="about-us-content-left">
            Nos inspiramos en nuestros usuarios para crear un futuro brillante,
            donde el crecimiento de unos, es el crecimiento de todos.
          </p>
        </div>
        <div className="about-us-img-right">
